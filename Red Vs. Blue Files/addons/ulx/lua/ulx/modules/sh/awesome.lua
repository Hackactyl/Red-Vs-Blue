...
local CATEGORY_NAME  = "TTT Awesome"
...
--]]
function ulx.credit( calling_ply, target_plys, amount, should_silent )
...
local credit = ulx.command( CATEGORY_NAME, "ulx credit", ulx.credit, "!credit")
credit:addParam{ type=ULib.cmds.PlayersArg }
credit:addParam{ type=ULib.cmds.NumArg, hint="Credits", ULib.cmds.round }
credit:defaultAccess( ULib.ACCESS_SUPERADMIN )
credit:setOpposite( "ulx silent credit", {_, _, _, true}, "!scredit", true )
credit:help( "Gives the <target(s)> credits." )
--[End]----------------------------------------------------------------------------------------
